...
public class XMLScenarioLoader extends ScenarioLoader {
  ...
  public  Scenario loadScenario(File f) throws ScenarioLoadingException{
	...
	private Scenario load(File mainFile, Document doc) throws ScenarioLoadingException, NoSuchStateInspectorException, IOException, ClassNotFoundException, InvalidSimulatorRequest{
	...
	private void loadEMMAS(Scenario scenario, Element eEMMAS) throws ScenarioLoadingException, NoSuchStateInspectorException, IOException, ClassNotFoundException, InvalidSimulatorRequest{
