 ...
 * @throws NoSuchStateInspectorException 
   */
  public SimulationState createInitialState(ComponentsRegistry cr) throws ComponentInstantiationException, NoSuchStateInspectorException, ScenarioLoadingException, IOException, ClassNotFoundException, InvalidSimulatorRequest{
    Assert.notNull(cr);
 ...
 * @throws NoSuchStateInspectorException 
   */
  public List<IAgentControl> createAgentControls(ComponentsRegistry cr) throws ComponentInstantiationException, NoSuchStateInspectorException, ScenarioLoadingException, IOException, ClassNotFoundException, InvalidSimulatorRequest{
    Assert.notNull(cr);
